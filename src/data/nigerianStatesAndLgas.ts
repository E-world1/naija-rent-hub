...
export const lgasByState: LGAsByState = {
  "Abia": [
  ...
  "Borno": [
    "Abadam", "Askira/Uba", "Bama", "Bayo", "Bibi", "Chibok", "Damboa", "Dikwa", "Gubio", 
  ...
  "Oyo": [
    ...
    "Oluyole", "Ona Ara", "Orelope", "Ori Ire", "Oyo", "Oyo East", "Saki East", "Saki West", "Surulere"
  ],
  "Plateau": [
